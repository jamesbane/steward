...
class WirelessPortSerializer(serializers.ModelSerializer):
    class Meta:
...
class WirelessPortHistorySerializer(serializers.ModelSerializer):
    class Meta:
        model = models.WirelessPortHistory
        fields = ('cc', 'number', 'user', 'modified', 'action')
