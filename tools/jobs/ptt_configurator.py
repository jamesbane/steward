    ...
    def configure_group(self, provider_id, group_id, level=0):
        ...
        for user in users:
            ...
            if resp1['type'] == 'c:SuccessResponse':
                ...
                devices = list()
                # primary device
                log.write("{}UserGetRequest19({}) ".format('    '*(level+1), user_id))
                ...
                log.write('{}UserSharedCallAppearanceGetRequest16sp2(userId={}) >> '.format('    '*(level+1), user_id)),
                ...
                for device in devices:
                    ...
                    log.write('{}Device: {}\n'.format('    '*(level+2), device_name))
                    log.write('{}GroupAccessDeviceCustomTagGetListRequest({}, {}, {}) '.format('    '*(level+3), provider_id, group_id, device_name))
                    ...
                    if device['device_level'] == 'Group':
                        for tag in tags:
                            ...
                            if tag_name in device_tags:
                                log.write('{}GroupAccessDeviceCustomTagModifyRequest(serviceProviderId={}, groupId={}, deviceName={}, tagName={}, tagValue={}) >> '.format('    '*(level+3), provider_id, group_id, device['device_name'], tag_name, tag_value)),
                                ...
                                log.write(self.parse_response(resp4, (level+3)))
                            else:
                                log.write('{}GroupAccessDeviceCustomTagAddRequest(serviceProviderId={}, groupId={}, deviceName={}, tagName={}, tagValue={}) >> '.format('    '*(level+3), provider_id, group_id, device['device_name'], tag_name, tag_value)),
                        ...
                        for tag in tags:
                            ...
                            tag_value = tag['tag_value']
                            if tag_name in device_tags:
                                log.write('{}ServiceProviderAccessDeviceCustomTagModifyRequest(serviceProviderId={}, deviceName={}, tagName={}, tagValue={}) >> '.format('    '*(level+3), provider_id, device['device_name'], tag_name, tag_value)),
                                ...
                                log.write(self.parse_response(resp5, (level+3)))
                            else:
                                log.write('{}ServiceProviderAccessDeviceCustomTagAddRequest(serviceProviderId={}, deviceName={}, tagName={}, tagValue={}) >> '.format('    '*(level+3), provider_id, device['device_name'], tag_name, tag_value)),
